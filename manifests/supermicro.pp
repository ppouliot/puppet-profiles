class profiles::supermicro {
  ...
  archive{'LP-X10DRT-P-PT-PIBF-PIBQ_BIOS_3.0a_release_notes.pdf":
  ...
  archive{'X10_memory_config_guide.pdf":
  ...
  archive{'LP-X10DRT-P-PT-PIBF-PIBQ_IPMI_3.66_release_notes.pdf":
  ...
  archive{'CDR-X10_1.10_for_Intel_X10_platform.iso':
  ...
  archive{'CDR-X10_1.11_for_Intel_X10_platform.iso':
