...
#  class{'profiles::shipyard':}
  ...
  class {'jenkins':
    ...
    plugin_hash                          => {
      ...
      'build-flow-extensions-plugin'        => { 'ensure' => 'absent' },
      'build-flow-plugin'                   => { 'ensure' => 'absent' },
      'build-flow-test-aggregator'          => { 'ensure' => 'absent' },
      'build-flow-toolbox-plugin'           => { 'ensure' => 'absent' },
      # 
